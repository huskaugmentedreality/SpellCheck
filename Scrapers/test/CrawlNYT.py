...
def getArticle(destination, url):
    ...
    url = ""
    try:
        urlString = myArticle.find("meta", {"property":"og:url"})
        print (urlString["content"])
    except:
...
getArticle(".", "https://www.nytimes.com/2019/01/19/us/politics/trump-announcement-daca-wall.html")
